...
public class Main {
    ...
    public static void main(String arg[]) {
        ...
        System.out.println("Capture XMPP is Starting ......\n ");
    ...
    private void agentToCapture() {
        for (Map.Entry<String, String> entry : agentsMap.entrySet()) {
            try {
                ...
                System.out.println(entry.getKey() + " Thread started !");
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    private void getAgentFromXML() {
        try {
            ...
            System.out.println("Total Agents To Subscribe = " + nList.getLength());
            System.out.println("----------------------------");
            ...
            for (int temp = 0; temp < nList.getLength(); temp++) {
                ...
                if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    //for logging purpose
                    System.out.println("User ID : " + agentID);
